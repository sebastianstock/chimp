...
public class LookUpTableDurationEstimator implements MoveBaseDurationEstimator {
	...
	static {
		...
		boundsTable.put("preManipulationAreaEastCounter1", "preManipulationAreaNorthTable1", new Bounds(40000, 60000));
		boundsTable.put("preManipulationAreaEastCounter1", "preManipulationAreaSouthTable1", new Bounds(30000, 50000));
		boundsTable.put("preManipulationAreaEastCounter1", "preManipulationAreaWestTable2" , new Bounds(70000, 90000));
		boundsTable.put("preManipulationAreaEastCounter1", "preManipulationAreaEastTable2" , new Bounds(60000, 80000));
		boundsTable.put("preManipulationAreaEastCounter1", "floorAreaTamsRestaurant1"      , new Bounds(30000, 40000));
		
		boundsTable.put("preManipulationAreaNorthTable1", "preManipulationAreaEastCounter1", new Bounds(40000, 60000));
		...
		boundsTable.put("preManipulationAreaSouthTable1", "preManipulationAreaEastCounter1", new Bounds(30000, 50000));
		...
		boundsTable.put("preManipulationAreaWestTable2", "preManipulationAreaEastCounter1", new Bounds(70000, 90000));
		...
		boundsTable.put("preManipulationAreaEastTable2", "preManipulationAreaEastCounter1", new Bounds(60000, 80000));
