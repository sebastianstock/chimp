...
public class LookUpTableDurationEstimator implements MoveBaseDurationEstimator {
	...
	static {
		// "preManipulationAreaEastCounter1"
		boundsTable.put("preManipulationAreaEastCounter1", "preManipulationAreaEastCounter1", new Bounds(0, 1));
		...
		boundsTable.put("preManipulationAreaNorthTable1", "preManipulationAreaNorthTable1", new Bounds(0, 1));
		...
		boundsTable.put("preManipulationAreaSouthTable1", "preManipulationAreaSouthTable1", new Bounds(0, 1));
		...
		boundsTable.put("preManipulationAreaWestTable2", "preManipulationAreaWestTable2" , new Bounds(0, 1));
		...
		boundsTable.put("preManipulationAreaEastTable2", "preManipulationAreaEastTable2" , new Bounds(0, 1));
		...
		boundsTable.put("floorAreaTamsRestaurant1", "floorAreaTamsRestaurant1"      , new Bounds(0, 1));
	}
