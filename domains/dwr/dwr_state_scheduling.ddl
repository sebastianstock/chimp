...
(StateVariable r_loc 1 r1)
#(StateVariable d_occupant 1 d1 d2 d3)
#(StateVariable k_attached 1 k1 k2 k3)
...
(:operator
 ...
 (Add e1t r_loc(?robot ?moving))
 (Values ?moving moving)
 (Del e1t)
# (Constraint Meets(task,e1t))
 #(Constraint Meets(p1,e1t))
 (Add e1 r_loc(?robot ?waypoint))
# (Constraint Meets(e1t,e1))
# (Constraint Meets(task,e1))
# (Constraint Duration[10000,10000](e1))
# (Constraint Duration[10000,10000](e1t))
