...
(:operator
 ...
 (Values ?free free)
 (ResourceUsage (Usage r1Activity 1) (Param 1 r1))
 (ResourceUsage (Usage r2Activity 1) (Param 1 r2))   
)
...
(:operator
 ...
 (ResourceUsage (Usage r1Activity 1) (Param 3 r1))
 (ResourceUsage (Usage r2Activity 1) (Param 3 r2))   
)
...
(:method 1
 ...
 (Ordering s1 s2)
 (Ordering s2 s3)
 (ResourceUsage (Usage r1Goto 1) (Param 1 r1))
 (ResourceUsage (Usage r2Goto 1) (Param 1 r2))   
...
(:method 1
 ...
 (Ordering s3 s4)
 (Ordering s4 s5)
 (ResourceUsage (Usage r1RobotBring 1) (Param 1 r1))
 (ResourceUsage (Usage r2RobotBring 1) (Param 1 r2))   
)